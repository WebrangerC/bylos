...
Habits can be good (brush your teeth every morning/evening) or bad(looking at stock market results daily). I've got those two and a bunch more, but I'm trying to overbalance on the "good habit" side.  It should be no surprise that I'm using Obsidian.md to help. My current effort is the attempt to stay active in the three [[+About Focus_f|Focuses]] driving my LifeOS. I have added a little tracker to my Daily Note:
